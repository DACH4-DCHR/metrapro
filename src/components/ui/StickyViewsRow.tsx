...
// pantalla (88px en sm+, 100px cuando el encabezado se apila en móvil). Siempre en
...
export function StickyViewsRow({ children }: StickyViewsRowProps) {
  return (
    <div className="sticky top-[100px] z-10 mb-6 grid grid-cols-2 gap-2 sm:top-[92px] sm:gap-4">{children}</div>
  );
}
