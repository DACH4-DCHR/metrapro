...
export function LosaMacizaPlanView({ input }: LosaMacizaPlanViewProps) {
  ...
  const sepXM = Math.max(input.separacionPrincipal, 1) / 100;
  const sepYM = Math.max(input.separacionTemperatura, 1) / 100;
