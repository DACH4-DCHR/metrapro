...
- Sistema de usuarios y permisos (login, multiusuario con proyectos separados por cuenta).
...
- **Backend**: Node.js + Express, `node:sqlite` (módulo nativo de Node, sin dependencias binarias externas).
